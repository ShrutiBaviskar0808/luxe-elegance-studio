            ...
            {cart.length > 0 && (
              <footer className="border-t border-foreground/10 px-6 py-5 space-y-3">
                ...
                <button
                  ...
                  className="shine w-full rounded-full bg-gradient-to-r from-onyx to-foreground text-background py-3 text-[11px] uppercase tracking-[0.3em] hover:shadow-lg transition font-semibold"
                >
                  Secure Checkout
                </button>
                <a
