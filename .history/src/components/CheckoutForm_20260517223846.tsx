        ...
        <div className="space-y-8">
          ...
          >
            <Button
              ...
              size="lg"
              className="w-full h-12 bg-gradient-to-r from-onyx to-foreground hover:from-onyx/90 hover:to-foreground/90 text-background font-semibold tracking-wide text-base transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {paymentLoading ? (
