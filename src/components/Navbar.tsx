...
const links = [
  ...
  { label: "Earrings", href: "#new-arrival", category: "Earrings" as Cat },
  { label: "Rings", href: "#new-arrival", category: "Rings" as Cat },
  { label: "Bracelets", href: "#new-arrival", category: "Bracelets" as Cat },
];
